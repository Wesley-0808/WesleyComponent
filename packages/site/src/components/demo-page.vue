...
<script>
const demoVueReq = import.meta.glob('@wesley/components/**/_example/*.vue', { eager: true });
const demoJsxReq = import.meta.glob('@wesley/components/**/_example/*.jsx', { eager: true });
